#ifndef __BULLET_FOR_ENEMY01_H__
#define __BULLET_FOR_ENEMY01_H__
...
class BulletForEnemy1 : public basic_Bullet
{
public:
	static BulletForEnemy1* create(const string& bullet,
